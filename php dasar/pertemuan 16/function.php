...
function regiss($data){
    ...
    $password = mysqli_real_escape_string($k ,$data["password"]);
    $password2 = mysqli_real_escape_string($k , $data["pasword2"]);

    //username udh ada apa blom
    $result = mysqli_query($k , "SELECT username FROM user WHERE username = '$username'");
    ...
    mysqli_query($k, "INSERT INTO user VALUES('','$username','$password')");
