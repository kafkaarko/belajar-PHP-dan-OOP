...
<body>
    <a href="logout.php" class="lg">logout</a>
    <h1>daftar siswa</h1>

    <a href="tambah.php" class="tb">tambah data siswa</a>
    <br><br>

    <form action="" method="post">

    <input type="text" name="keyword"  class="cr"  size="25" autofocus placeholder="masukan kata kunci" autocomplete="off" id="keyword">
